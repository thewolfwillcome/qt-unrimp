...
// [CHANGED]
// - Put the source code into a C-string by adding "\n\"
// - Added "FXAA_GLSL_100" for OpenGL ES 2 support
...
static const char *fxaa_FS_Part1 = "\
/*============================================================================\n\
									API PORTING\n\
============================================================================*/\n\
...
float4 FxaaTexGrad(FxaaTex tex, float2 pos, float2 grad) {\n\
	#if FXAA_GLSL_100\n\
		// TODO(co) Emulate texture2DGrad in OpenGL ES 2\n\
...
----------------------------------------------------------------------------*/\n\
	...
	#endif\n\
";
static const char *fxaa_FS_Part2 = "\
/*----------------------------------------------------------------------------\n\
								COMPUTE LOWPASS\n\
------------------------------------------------------------------------------\n\
