...
#ifndef FIRSTPOSTPROCESSING_H
#define FIRSTPOSTPROCESSING_H

#include "UnrimpExamples/ExampleBase.h"

class FirstPostProcessing : public ExampleBase
{
public:
	virtual void Init(Renderer::IRendererPtr renderer) override;
	virtual void Deinit() override;
	virtual void Render() override;
    virtual QString name() { return "FirstPostProcessing"; } override;
...
private:
	...
	*/
	void recreateFramebuffer(Renderer::IRendererPtr renderer);

	/**
	*  @brief
	*    Scene rendering
	*/
	void sceneRendering(Renderer::IRendererPtr renderer);

	/**
	*  @brief
	*    Post-processing
	*/
	void postProcessing(Renderer::IRendererPtr renderer);
